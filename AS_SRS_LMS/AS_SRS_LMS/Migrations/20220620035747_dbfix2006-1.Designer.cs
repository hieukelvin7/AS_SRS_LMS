...
namespace AS_SRS_LMS.Migrations
{
    ...
    [Migration("20220620035747_dbfix2006-1")]
    partial class dbfix20061
    {
            ...
            modelBuilder.Entity("AS_SRS_LMS.Models.Schedule", b =>
                {
                    ...
                    b.HasOne("AS_SRS_LMS.Models.LearningSchedule", "LearningSchedule")
                        .WithMany("Schedules")
                        .HasForeignKey("LearningScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
